# [aardee](https://github.com/aardee)’s dotfiles forked from [alrra's dotfiles)](https://github.org/alrra/dotfiles)
...
| OS | Snippet |
|:---|:---|
| `macOS` | `bash -c "$(curl -LsS https://raw.github.com/aardee/dotfiles/master/src/os/setup.sh)"` |
| `Ubuntu` | `bash -c "$(wget -qO - https://raw.github.com/aardee/dotfiles/master/src/os/setup.sh)"` |
...
`setup` script](https://github.com/aardee/dotfiles/blob/1503cf23ef23f6e31342b140bcd246625160b94f/src/os/setup.sh#L3).
...
* [alrra's dotfiles](https://github.com/alrra)
